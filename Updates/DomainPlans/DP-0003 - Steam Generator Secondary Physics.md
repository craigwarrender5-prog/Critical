...
|---|---|---|---|---|---|
| CS-0048 | Steam generator secondary stays near atmospheric and behaves as constant heat sink during heat-up | Critical | Assigned | - | Observed failure confirmed in evidence set; preliminary investigation complete. |
| CS-0047 | Heat-up progression stalls during intended startup heat addition | Critical | Assigned | - | Observed failure confirmed in evidence set; preliminary investigation complete. |
| CS-0014 | SG "ISOLATED" mode behaves like open inventory pressure boundary | Critical | Assigned | - | Not Tested |
| CS-0015 | Steam generation does not accumulate compressible volume/mass (no internal pressure build) | Critical | Assigned | - | Not Tested |
| CS-0016 | SG modeled as unrealistically strong heat sink during heatup | Critical | Assigned | - | Not Tested |
...
| CS-0018 | N2 blanket treated as pressure clamp, not compressible cushion | High | Assigned | - | Not Tested |
