...
public partial class HeatupSimEngine
{
    ...
    void SaveIntervalLog()
    {
        ...
        sb.AppendLine($"    Dyn Active Intv:  {stageE_DynamicActiveHeatingIntervalCount,10}");
        sb.AppendLine($"    Dyn P Rise Chk:   {stageE_DynamicPrimaryRiseCheckCount,10}");
        sb.AppendLine($"    Dyn P Rise PASS:  {stageE_DynamicPrimaryRisePassCount,10}");
        sb.AppendLine($"    Dyn P Rise FAIL:  {stageE_DynamicPrimaryRiseFailCount,10}");
        sb.AppendLine($"    Dyn Last dP:      {stageE_DynamicLastPressureDelta_psia,10:F3} psia");
        sb.AppendLine($"    Dyn dT3 Last:     {stageE_DynamicTempDelta3Last_F,10:F2} F");
        sb.AppendLine($"    Dyn dT3 Min/Max:  {stageE_DynamicTempDelta3Min_F,5:F2}/{stageE_DynamicTempDelta3Max_F,4:F2} F");
        sb.AppendLine($"    Dyn dT3 >5F Cnt:  {stageE_DynamicTempDelta3Above5Count,10}");
        sb.AppendLine($"    Dyn dT3 <2F Cnt:  {stageE_DynamicTempDelta3Below2Count,10}");
        sb.AppendLine($"    Dyn Flat3 Cnt:    {stageE_DynamicPressureFlatline3Count,10}");
        sb.AppendLine($"    Dyn Clamp Cnt:    {stageE_DynamicHardClampViolationCount,10}");
        sb.AppendLine($"    Dyn Top-Tsat:     {stageE_DynamicLastTopToTsatDelta_F,10:F2} F");
    ...
    void SaveReport()
    {
        ...
        sb.AppendLine($"  Dynamic Active Intv:  {stageE_DynamicActiveHeatingIntervalCount}");
        sb.AppendLine($"  Dynamic P Rise Chk:   {stageE_DynamicPrimaryRiseCheckCount}");
        sb.AppendLine($"  Dynamic P Rise PASS:  {stageE_DynamicPrimaryRisePassCount}");
        sb.AppendLine($"  Dynamic P Rise FAIL:  {stageE_DynamicPrimaryRiseFailCount}");
        sb.AppendLine($"  Dynamic Last dP:      {stageE_DynamicLastPressureDelta_psia:F3} psia");
        sb.AppendLine($"  Dynamic dT3 Windows:  {stageE_DynamicTempDelta3WindowCount}");
        sb.AppendLine($"  Dynamic dT3 Last:     {stageE_DynamicTempDelta3Last_F:F2} F");
        sb.AppendLine($"  Dynamic dT3 Min:      {stageE_DynamicTempDelta3Min_F:F2} F");
        sb.AppendLine($"  Dynamic dT3 Max:      {stageE_DynamicTempDelta3Max_F:F2} F");
        sb.AppendLine($"  Dynamic dT3 >5F:      {stageE_DynamicTempDelta3Above5Count}");
        sb.AppendLine($"  Dynamic dT3 <2F:      {stageE_DynamicTempDelta3Below2Count}");
        sb.AppendLine($"  Dynamic Flatline3:    {stageE_DynamicPressureFlatline3Count}");
        sb.AppendLine($"  Dynamic Clamp Hits:   {stageE_DynamicHardClampViolationCount}");
        sb.AppendLine($"  Dynamic Top-Tsat:     {stageE_DynamicLastTopToTsatDelta_F:F2} F");
