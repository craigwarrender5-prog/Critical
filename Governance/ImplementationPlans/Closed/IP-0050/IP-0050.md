# IP-0050 â€” DP-0008 Operator Interface & Scenarios: PZR Temperature Monitoring
...
**Closeout Report:** Governance/ImplementationPlans/Closed/IP-0050/Reports/IP-0050_Closeout_Traceability.md

---

## 1. Problem Summary

The ValidationDashboard does not provide adequate monitoring of pressurizer temperature approach to saturation during cold startup. Per NRC HRTD 17.0, bubble formation occurs "when pressurizer temperature reaches saturation temperature for the pressure being maintained (450Â°F for 400 psig)." Without visual indication of T_pzr vs T_sat, operators cannot determine when the pressurizer is ready for bubble draw.
...
1. **PZR Subcooling Readout:** A digital readout showing `T_sat - T_pzr` (Â°F) displayed in the Pressurizer column, labeled "PZR Î”T_SAT" or "PZR SUBCOOL"
2. **PZR SAT Annunciator:** An INFO-severity annunciator tile "PZR SAT" that:
   - Shows GREEN (Normal) when T_pzr â‰¥ T_sat - 5Â°F (approaching/at saturation)
   - Shows GRAY (Off) when T_pzr < T_sat - 5Â°F (subcooled)
...
- **LOW** â€” All changes are additive to existing dashboard infrastructure
...
3. Add `PzrAtSaturation` boolean field (true when PzrSubcooling â‰¤ 5Â°F)
...
**Changes:**
1. Add digital readout "PZR Î”T_SAT" showing `s.PzrSubcooling` in Â°F
2. Position after T_pzr readout or in appropriate location
3. Color-code: Green when â‰¤ 5Â°F, normal otherwise
...
5. Verify annunciator tile "PZR SAT" activates (green) when subcooling â‰¤ 5Â°F
...
- CS-0102 (Scenario system framework) â€” Separate IP
- CS-0103 (Scenario selection overlay) â€” Separate IP
...
| v1.1 | 2026-02-18 | Codex | Finalized closure transaction, moved IP to Closed plans, and added closeout traceability artifact. | Complete governance closeout and registry/archive alignment for IP-0050. |
...
**Executed:** 2026-02-17  
**Closed:** 2026-02-17  
**Closure Transaction Finalized:** 2026-02-18
...
- Stage 3: Digital readout "PZR Î”T_SAT" added to Pressurizer column
