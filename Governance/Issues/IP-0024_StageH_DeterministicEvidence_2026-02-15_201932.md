...
- Timestamp: 2026-02-15 20:19:34
- Run stamp: `2026-02-15_201932`

## Run List
- Cold-shutdown equilibrium hold (Stage D reuse): `HeatupLogs/IP-0024_StageD_Hold_2026-02-15_201932`
- Startup + bubble + drain deterministic run: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932`
- Heatup report: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932/Heatup_Report_20260215_201934.txt`
- Startup sequence timeseries: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932/IP-0024_StartupSequence_Timeseries.csv`
- Bubble continuity/phase plot data: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932/IP-0024_PhaseContinuity_Timeseries.csv`
- Solver residual log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932/IP-0024_SolverAttempts.csv`
- DRAIN causality log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932/IP-0024_DrainCausality.csv`
- DRAIN causality micro-run log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932/IP-0024_DrainCausality_MicroRun.csv`
- RVLIS integrity log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201932/IP-0024_RVLIS_DrainConsistency.csv`
- Authoritative final run artifacts for IP-0024 closeout:
  - `Governance/Issues/IP-0024_StageD_ExitGate_SinglePhaseHold_2026-02-15_201932.md`
  - `Governance/Issues/IP-0024_StageH_DeterministicEvidence_2026-02-15_201932.md`
- Interim failed run retained for historical traceability and explicitly superseded by PASS run stamp `2026-02-15_201932`:
  - `Governance/Issues/IP-0024_StageH_DeterministicEvidence_2026-02-15_194447.md`
...
- RVLIS consistency: PASS | fullInvalid=0, upperInvalid=0, changeCoverage=1.00, signAlignment=1.00, cappedPairs=352, activePairs=7
