...
- Timestamp: 2026-02-15 20:15:23
- Run stamp: `2026-02-15_201519`

## Run List
- Cold-shutdown equilibrium hold (Stage D reuse): `HeatupLogs/IP-0024_StageD_Hold_2026-02-15_201519`
- Startup + bubble + drain deterministic run: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519`
- Heatup report: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519/Heatup_Report_20260215_201523.txt`
- Startup sequence timeseries: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519/IP-0024_StartupSequence_Timeseries.csv`
- Bubble continuity/phase plot data: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519/IP-0024_PhaseContinuity_Timeseries.csv`
- Solver residual log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519/IP-0024_SolverAttempts.csv`
- DRAIN causality log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519/IP-0024_DrainCausality.csv`
- DRAIN causality micro-run log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519/IP-0024_DrainCausality_MicroRun.csv`
- RVLIS integrity log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201519/IP-0024_RVLIS_DrainConsistency.csv`
