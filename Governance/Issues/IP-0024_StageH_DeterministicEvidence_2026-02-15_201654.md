...
- Timestamp: 2026-02-15 20:16:58
- Run stamp: `2026-02-15_201654`

## Run List
- Cold-shutdown equilibrium hold (Stage D reuse): `HeatupLogs/IP-0024_StageD_Hold_2026-02-15_201654`
- Startup + bubble + drain deterministic run: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654`
- Heatup report: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654/Heatup_Report_20260215_201658.txt`
- Startup sequence timeseries: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654/IP-0024_StartupSequence_Timeseries.csv`
- Bubble continuity/phase plot data: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654/IP-0024_PhaseContinuity_Timeseries.csv`
- Solver residual log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654/IP-0024_SolverAttempts.csv`
- DRAIN causality log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654/IP-0024_DrainCausality.csv`
- DRAIN causality micro-run log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654/IP-0024_DrainCausality_MicroRun.csv`
- RVLIS integrity log: `HeatupLogs/IP-0024_StageH_Suite_2026-02-15_201654/IP-0024_RVLIS_DrainConsistency.csv`

## Convergence Dashboard
- Attempts: 3660
- Converged: 1
- Convergence %: 0.03%
- Mean / Max |Volume residual|: 0.71865 / 0.96000 ft^3
- Mean / Max |Energy residual|: 0.00000 / 0.00000 BTU
- Pattern breakdown: monotonic=3302, bounded_oscillatory=358, other=0
- Failure reason breakdown:
  - MASS_CONTRACT_RESIDUAL: 3658
  - NONE: 2
...
- Failure classes observed: MASS_CONTRACT_RESIDUAL=3658, NONE=2
...
|---|---|---|---|
| CS-0091 | Stage H deterministic run + forced failure check + bracket probe | convergence>=95%, MASS_CONTRACT_RESIDUAL=0, clean fail/no-commit true, bracket probe finds bracket, reason histogram populated | FAIL |
